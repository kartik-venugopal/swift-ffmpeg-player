...
class FFmpegDecoder {
    ...
    ///
    var fileCtx: FFmpegFormatContext
    ...
    ///
    init(for fileContext: FFmpegFormatContext) throws {
    ...
    func decode(maxSampleCount: Int32, intoFormat outputFormat: AVAudioFormat) -> AVAudioPCMBuffer? {
        ...
        while !eof {
            ...
            do {
                ...
                self._eof.value = packetReadError.isEOF
